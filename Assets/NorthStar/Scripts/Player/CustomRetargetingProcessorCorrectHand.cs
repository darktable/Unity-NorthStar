...
{
    /// <summary>
    /// NOTE: This is a modified/repurposed version of the original RetargetingProcessorCorrectHand class that has added support for overriding hand rotation
    /// 
    ...
    public sealed class CustomRetargetingProcessorCorrectHand : RetargetingProcessor
    {
        ...
        public class HandProcessor
        {
            ...
            /// <summary>
            /// If true, use the custom hand target rotation for the target rotation.
            /// </summary>
            [SerializeField]
            private bool _useCustomHandTargetRotation = true;

            public bool UseCustomHandTargetRotation
            {
                get => _useCustomHandTargetRotation;
                set => _useCustomHandTargetRotation = value;
            }


            [SerializeField]
            private Vector3 _customHandRotationOffset;

            public Vector3 CustomHandRotationOffset
            {
                get => _customHandRotationOffset;
            ...
            /// <summary>
            /// The custom hand target rotation.
            /// </summary>
            private Quaternion? _customHandTargetRotation;

            public Quaternion? CustomHandTargetRotation
            {
                get => _customHandTargetRotation;
                set => _customHandTargetRotation = value;
            }
            ...
            public void SetupRetargetingProcessor(RetargetingLayer retargetingLayer,
                CustomRetargetingProcessorCorrectHand parentProcessor, Handedness handedness)
            {
            ...
            public void ProcessRetargetingLayer(RetargetingLayer retargetingLayer, Vector3 targetHandPosition,
                CustomRetargetingProcessorCorrectHand parentProcessor)
            {
                // Handle blend hand.
            ...
            {
                for (var i = 0; i < _armBonesEndEffectorLast.Length; i++)
                {
                    var lastJoint = i == _armBonesEndEffectorLast.Length - 1;
                    _distanceToNextBoneEndEffectorLast[i] = lastJoint
                        ? 0f
                        : (_armBonesEndEffectorLast[i + 1].position -
        ...
        public class SyncOvrControllersAndHandsSettings
        {
            ...
            /// </summary>
            [SerializeField]
            private Vector3 _ovrHandControllerPositionOffset = new(0.04f, -0.04f, -0.11f);
        ...
        public override void CopyData(RetargetingProcessor source)
        {
            ...
            var sourceCorrectHand = source as CustomRetargetingProcessorCorrectHand;
